...
namespace GetSummonerNames
{
    public partial class Form1 : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Unable to connect to LCU or not in select", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }


            // Op.gg format is the following 
            // https://www.op.gg/multisearch/na?summoners=senva%2CI+AM+ND%2C
            // 
            if (!String.IsNullOrEmpty(_uggplayers)) Process.Start("https://www.op.gg/multisearch/" + _myregion.ToLower() + "?summoners=" + _uggplayers);

            //Console.WriteLine("PLAYERS: " + _uggplayers);
        }
    }
